...
Léteznek portálok, amely gyűjtő szerepet töltenek be az interneten. Itt egy átlagos felhasználó a látogatás után eléri az összes aloldalat, azonban előfordul, hogy az aloldalak már külön hatáskör alá tartoznak, így külön-külön regisztráció szükséges az egyes aloldalak felületeinek eléréséhez. Külön szolgáltatásoknak is lehet jogosultság nélkül elérhető felülete, mintpéldául webshopok esetében regisztráció nélkül is elérhető terméklista, vagy ingatlanok esetében elérhető lista a telkekről, azonban ezek interakciójához jogosultság azaz regisztráció szükséges, amiután a rendszer automatikusan szintet rendel a felhasználónak, alapértelmezésben 0, vagy felhasználói szinttel. Ezzel már igénybevehetők a főbb szolgáltatási egységek, kapcsolatteremtés az eladókkal, boltokkal. A magasabb jogosultsági szintekkel rendelkező felhasználók részére az adott aloldal adminisztrátora tud felhatalmazni felhasználókat, legyen az eladó, vagy újabb adminisztrátor kinevezése.

## 05. Igényelt üzleti folyamatok modellje
